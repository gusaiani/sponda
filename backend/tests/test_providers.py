...
class TestFetchHistoricalMarketCapsRouting:
    """The reported historical market cap is what lets the multiples chart
    value a past year without applying today's share count to it. FMP serves
