...
export interface TranslationDictionary {
  ...
  "compare.col_debt_to_equity": string;
  "compare.col_debt_ex_lease_to_equity": string;
  "compare.col_liabilities_to_equity": string;
  "compare.col_debt_to_earnings": string;
  "compare.col_debt_to_fcf": string;
  "compare.col_current_ratio": string;
  "compare.col_roe": string;
  "compare.col_price_to_book": string;
  "compare.col_pe": string;
  "compare.col_pfcf": string;
  "compare.col_peg": string;
  "compare.col_pfcf_peg": string;
  "compare.col_cagr_earnings": string;
  "compare.col_cagr_fcf": string;
  ...
  "fundamentals.col.pe": string;
  "fundamentals.col.pfcf": string;
  ...
  "mcp.hint_claude_app_path": string;
  "mcp.hint_claude_app_rest": string;
  "mcp.hint_chatgpt_path": string;
  "mcp.hint_chatgpt_rest": string;
  "mcp.copy": string;
  "mcp.copied": string;
