/**
 * The per-locale prose describing what Sponda measures.
 *
 * Lives here rather than inside `SeoArticle.tsx` because two surfaces render
 * it: the visually hidden article on the home page, and the markdown twin at
 * `/{locale}.md`. One copy, two readers.
 */
...
export interface SiteArticle {
  title: string;
  sections: SiteArticleSection[];
}

export const ARTICLES: Record<string, SiteArticle> = {
  pt: {
