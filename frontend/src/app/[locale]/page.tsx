      ...
      {locale === "pt" ? (
        <article className="homepage-explainer" style={{ position: "absolute", width: 1, height: 1, overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap" }}>
          ...
          <p>
            ...
            <Link href={`/${locale}/PETR4`}>PETR4</Link>,{" "}
            <Link href={`/${locale}/VALE3`}>VALE3</Link>,{" "}
            <Link href={`/${locale}/ITUB4`}>ITUB4</Link>,{" "}
            <Link href={`/${locale}/WEGE3`}>WEGE3</Link> e{" "}
            <Link href={`/${locale}/ABEV3`}>ABEV3</Link>, ou
        ...
        <article className="homepage-explainer" style={{ position: "absolute", width: 1, height: 1, overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap" }}>
          ...
          <p>
            ...
            <Link href={`/${locale}/VALE3`}>VALE3</Link>,{" "}
            <Link href={`/${locale}/ITUB4`}>ITUB4</Link>,{" "}
            <Link href={`/${locale}/WEGE3`}>WEGE3</Link> and{" "}
            <Link href={`/${locale}/ABEV3`}>ABEV3</Link>, or
